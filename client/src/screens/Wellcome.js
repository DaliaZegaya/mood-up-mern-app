  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomPart}>
        <Text style={styles.heading}>I'ts time to MoodUp</Text>
        <Text style={styles.subheading}>Thousand of people are using MoodUp</Text>
        <Text style={styles.subheading}>for tracking their moods</Text>
